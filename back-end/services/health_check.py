...
SERVICES = {
    'cv-evaluation': {
        'url': 'http://cv-evaluation:5000/health',
    ...
    'interview': {
        'url': 'http://interview:5001/health',
    ...
    'university-list': {
        'url': 'http://university-list:8000/docs',
...
def health_check():
    ...
    return jsonify({
        ...
        'summary': {
            ...
            'main_platform': 'http://localhost',
            'cv_evaluation': 'http://localhost:5000',
            'interview': 'http://localhost:5001', 
            'university_list': 'http://localhost:8000',
            'major_list': 'http://localhost:8001'
        }
    })
