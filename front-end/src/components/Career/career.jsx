            ...
            {[0, 1, 2, 3, 4, 5].map((optionIndex) => (
              <button
                ...
                className={`rounded-full border-2 transition-all duration-200 hover:scale-110 ${
                  userData.mbtiAnswers[q.id] === optionIndex ? "scale-110" : ""
                } ${
                ...
                style={{
                  borderColor: optionIndex < 3 ? "#568F87" : "#F5BABB",
                  background:
  ...
  return (
    <div className="min-h-screen" style={{ background: "#FFEFF2" }}>
      ...
      <div className="max-w-6xl mx-auto px-4 py-8">
        ...
        {currentStep === 0 && (
          <div
            className="glass rounded-lg shadow-md p-8 border"
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <div className="flex gap-4">
                  <label
                    className="flex items-center gap-3 px-4 py-3 border-2 rounded-lg cursor-pointer transition-all duration-200"
                    style={{
                      borderColor: "#568F87",
                      background: "#FFFFFF",
                    }}
                  ...
                  >
                    ...
                    />
                    <span className="font-medium" style={{ color: "#064232" }}>
                      Học sinh cấp 2
                    </span>
                  </label>
                  <label
              ...
              <button
                ...
                className="w-full px-6 py-3 text-white font-medium rounded-lg transition-opacity duration-200 shadow-md hover:shadow-lg hover:opacity-95 flex items-center justify-center gap-2"
        ...
        {currentStep === 3 && aiData && (
          <div className="space-y-6">
            ...
            {userData.grade === "grade11" ? (
                ...
                <div className="space-y-4">
                  {aiData.career_fields.map((field, index) => {
                    ...
                    return (
                      <div
                        key={index}
                        className="glass rounded-lg p-6 shadow-md border hover:shadow-lg transition-all duration-200"
                        style={{ borderColor: "#568F87", borderWidth: "0.5px" }}
                      >
                            ...
                            <div className="flex items-center gap-3">
                              ...
                              >
                                <div
                                  ...
                                  style={{
                                    width: field.compatibility,
                                    background:
                                      "linear-gradient(90deg,#0c5743,#568F87)",
                                  }}
                                />
                              </div>
                            </div>
              ...
              <div
                className="rounded-lg p-12 text-center shadow-lg cursor-pointer transition-all duration-500"
                style={{ background: "linear-gradient(90deg,#064232,#568F87)" }}
